				...
				<div class="card-body">
					...
					<div class="form-group">
						<div class="text-right">
							<a href="${root }board_main" class="btn btn-primary">목록보기</a>
							<c:if test="${loginUserBean.user_idx == readContentBean.content_write }">
							<a href="${root }board_modify?board_info_idx=${board_info_idx}&content_idx=${content_idx}" class="btn btn-info">수정하기</a>
